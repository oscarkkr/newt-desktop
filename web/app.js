...
function bind(){
 ...
 $("#room").onchange=()=>{state.roomId=$("#room").value.trim();load(true)};$("#settings-form").onsubmit=saveSettings;$("#compose-form").onsubmit=post;$("#comment-form").onsubmit=comment;$("#reply-cancel").onclick=()=>setReplyTarget(null);
 ...
 $("#font-scale").oninput=e=>setFontScale(e.target.value,true);bindResizeHandle();
